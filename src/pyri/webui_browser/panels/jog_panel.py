...
class PyriJogPanel(PyriWebUIBrowserPanelBase):
    ...
    def jog_decrement_mouseup(self, joint_index):
        print(f"jog_decrement_mouseup: {joint_index}")

    def jog_increment_mousedown(self, joint_index):
        print(f"jog_increment_mousedown: {joint_index}")

    def jog_increment_mouseup(self, joint_index):
        print(f"jog_increment_mouseup: {joint_index}")
...
async def add_jog_panel(panel_type: str, core: PyriWebUIBrowser, parent_element: Any):
    ...
    jog_panel = js.Vue.new({
        ...
        "methods":
        {
            ...
            "jog_decrement_mouseup": jog_panel_obj.jog_decrement_mouseup,
            "jog_increment_mousedown": jog_panel_obj.jog_increment_mousedown,
            "jog_increment_mouseup": jog_panel_obj.jog_increment_mouseup
        },
        "computed": 
        {
